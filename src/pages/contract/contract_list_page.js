            ...
            <Col md={9}>
                <Card>
                    <CardHeader className='d-flex justify-content-between align-items-center'>
                        ...
                        <ButtonGroup>
                            <ToggleButton type="radio" variant='outline-secondary' checked={true} onClick={() => handleViewModeButtonClick(AppUrlConstant.CONTRACT_LIST_PAGE_URL)}><i className="fa-solid fa-list"></i></ToggleButton>
